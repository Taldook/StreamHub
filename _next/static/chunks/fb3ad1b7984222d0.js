(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
      ...
      return (0, t.jsxs)("div", {
        ...
        children: [
          e &&
            (0, t.jsxs)("div", {
              className:
                "flex flex-row items-center gap-3 rounded-full border border-Stream-border px-4 py-2",
              children: [
                (0, t.jsx)("span", {
                  children: l
                    ? (0, t.jsx)(s.default, {
          ...
          (0, t.jsx)("p", {
            className:
              "max-w-md text-sm text-Stream-muted-foreground md:text-base",
            children: r,
          }),
        ],
      });
                ...
                "div",
                {
                  ...
                  children: l.map((l) =>
                    (0, t.jsxs)(
                      ...
                      {
                        className:
                          "relative h-44 overflow-hidden rounded-xl border border-Stream-border opacity-70 transition-opacity duration-300 ease-linear hover:opacity-100 sm:h-64 md:h-auto",
                        children: [
                          (0, t.jsx)(s.default, {
                            src: l.desktop,
                          ...
                          (0, t.jsx)("div", {
                            className:
                              "absolute inset-0 flex flex-1 items-end justify-end bg-gradient-to-b from-transparent via-background/10 to-background p-4 text-sm font-medium text-Stream-muted-foreground",
  ...
  (e) => {
    ...
    e.s([
      ...
      0,
      {
        ...
        StreamCloudFrame: "/images/decor/cloud.svg",
                  ...
                  children: [
                    (0, t.jsxs)("div", {
                      ...
                      children: [
                        (0, t.jsxs)("div", {
                          className:
                            "flex flex-row items-center gap-3 rounded-full border border-Stream-accent-secondary/20 bg-Stream-accent-secondary/10 px-4 py-2 text-Stream-accent-secondary transition-all duration-300 ease-in-out hover:border-Stream-accent-secondary/40 hover:bg-Stream-accent-secondary/20",
                          children: [
                            (0, t.jsx)("span", {
                        ...
                        (0, t.jsxs)("p", {
                          ...
                          children: [
                            ...
                            (0, t.jsx)("span", {
                              className:
                                "bg-gradient-to-r from-Stream-accent-primary to-Stream-accent-secondary bg-clip-text font-bold text-transparent",
                              children: "Cloud",
                            }),
                          ],
                        }),
                        (0, t.jsx)("p", {
                          className:
                            "max-w-lg text-sm text-Stream-muted-foreground md:text-base",
                    ...
                    (0, t.jsx)("div", {
                      children: d.map((e, l) =>
                        (0, t.jsxs)(
                          ...
                          {
                            className: (0, n.cn)(
                              "mt-6 flex flex-col gap-3 border-t border-Stream-border pt-4 transition-opacity duration-300 ease-linear lg:max-w-lg lg:border-l lg:border-t-0 lg:pl-6 lg:pt-0",
                            ...
                            children: [
                              ...
                              (0, t.jsx)("p", {
                                className:
                                  "text-sm text-Stream-muted-foreground",
                    ...
                    (0, t.jsx)(i.Button, {
                      href: "https://checkout.Streamlauncher.gg/",
                      className:
      ...
      return (0, t.jsxs)("section", {
        ...
        children: [
          (0, t.jsx)(s.default, {
            ...
            alt: "Stream Download",
            className:
              "absolute inset-0 size-0 rounded-lg border border-Stream-border xl:relative xl:h-[395px] xl:w-[680px] xl:opacity-100",
            height: 395,
            width: 680,
          }),
          (0, t.jsxs)("div", {
            ...
            children: [
                ...
                children: [
                  ...
                  (0, t.jsx)("div", {
                    ...
                    children: c
                      ...
                      : (0, t.jsxs)(i.Button, {
                          href: "https://github.com/Streamlauncher/Stream-installer/releases/download/v1.0.0/Stream-installer.exe",
                          download:
                            "https://github.com/Streamlauncher/Stream-installer/releases/download/v1.0.0/Stream-installer.exe",
                  ...
                  (0, t.jsx)("div", {
                    ...
                    children: (0, t.jsx)("div", {
                      className:
                        "flex w-full flex-col items-center justify-center overflow-hidden rounded-lg border border-Stream-border",
                      children: (0, t.jsx)(s.default, {
                        src: a.Decor.downloadFrame,
                        alt: "Stream Download",
              ...
              (0, t.jsxs)("div", {
                className: "mt-6 border-t border-Stream-border",
                children: [
                  (0, t.jsx)("p", {
                    className:
                      "max-w-lg pb-3 pt-6 text-sm text-Stream-muted-foreground md:text-base",
        ...
        children: [
          ...
          (0, t.jsx)("div", {
            ...
            children: (0, t.jsx)(s.default, {
              ...
              alt: "Stream FAQ",
              className: "hidden rounded-xl border border-Stream-border lg:flex",
              height: 384,
              width: 423,
            }),
          }),
  ...
  (e) => {
    ...
    function m() {
      return (0, t.jsxs)("div", {
        className:
          "absolute left-0 top-0 -z-10 h-[100vh] w-full overflow-hidden border-b border-Stream-accent-primary",
        children: [
          (0, t.jsx)("div", {
            className:
              "absolute bottom-0 left-0 right-0 h-[60%] bg-gradient-to-t from-Stream-accent-secondary/90 to-background",
          }),
          (0, t.jsx)("div", {
            className:
    ...
    function h({ release: e }) {
      ...
      let p = `https://github.com/Streamlauncher/Stream/releases/tag/${e.tagName}`;
      return (0, t.jsxs)("section", {
              ...
              (0, t.jsxs)("div", {
                ...
                children: [
                  (0, t.jsxs)(r.Button, {
                    ...
                    target: "_blank",
                    className:
                      "rounded-full border bg-secondary/50 text-sm font-normal text-Stream-muted-foreground",
                    children: [
                      (0, t.jsx)(l.default, {
                  ...
                  (0, t.jsx)("p", {
                    className: "text-sm text-Stream-muted-foreground lg:hidden",
                  ...
                  (0, t.jsx)("p", {
                    className:
                      "hidden max-w-lg text-Stream-muted-foreground lg:block",
                  ...
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      (0, t.jsxs)(r.Button, {
                        href: "https://t.me/Streamlauncher",
                        target: "_blank",
        ...
        (0, t.jsx)("div", {
          ...
          children: n.map((e, l) =>
            (0, t.jsxs)(
              ...
              {
                className: (0, r.cn)(
                  "flex flex-col gap-2 border-t-2 border-Stream-border pt-4 transition-opacity duration-500 ease-in-out lg:max-w-sm",
                ...
                children: [
                  ...
                  (0, t.jsx)("p", {
                    className:
                      "mr-8 text-sm font-light text-Stream-muted-foreground",
                    children: e.description,
                  }),
                ],
              },
              ...
              (0, t.jsxs)("div", {
                ...
                children: [
                  (0, t.jsx)("p", {
                    ...
                    children: n("what_is_Stream_title"),
                  }),
                  (0, t.jsxs)("div", {
                    ...
                    children: [
                      (0, t.jsx)("p", {
                        ...
                        children: n("what_is_Stream_description_1"),
                      }),
                      (0, t.jsx)("p", {
                        className: "pointer-events-auto text-sm md:text-base",
                        children: n("what_is_Stream_description_2"),
                      }),
                    ],
                  }),
                ],
            ...
            [
              {
                ...
                color: "bg-Stream-accent-secondary",
              ...
              children: x
                ...
                .map((e) =>
                  (0, t.jsxs)(
                    ...
                    {
                      className: (0, i.cn)(
                        "flex w-full flex-col gap-2 rounded-xl border border-Stream-border p-6",
                      ...
                      children: [
                        ...
                        (0, t.jsx)("p", {
                          className:
                            "text-sm text-Stream-muted-foreground md:text-sm",
                          children: e.description,
                        }),
                      ],
                    },
